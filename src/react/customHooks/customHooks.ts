...
export function useStateEx<T>(propValue: T, onChange?: (value: T) => void): [T, (value: T) => void] {
...
export function useStateRe<T>(
	value?: T,
	setter?: (old: T) => void,
	fallbackValue?: T,
): [T, React.Dispatch<React.SetStateAction<T>>] {
	return value !== undefined && setter !== undefined
		? [value, setter as React.Dispatch<React.SetStateAction<T>>]
		: useState(fallbackValue as T);
}
