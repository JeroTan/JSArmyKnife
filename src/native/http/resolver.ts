...
export const responseType = ["RAW", "JSON", "FILE", "BUFFER"] as const;
...
export class Resolve {
		...
		(async (THIS, callback) => {
			...
			if(responseType == "RAW"){
				...
				try{
					...
					try{
						throw new Error(`Failed to parse JSON response. We only received the following data: \n${await response.clone().text()}`);
					}catch(err){
	...
	protected statusExclusion<DATA extends object>(
		status: number,
		callback: Function,
	) {
	...
	public default(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
	...
	public s0(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//OK
		return this.statusExclusion(0, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s200(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//OK
		return this.statusExclusion(200, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s201(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Created
		return this.statusExclusion(201, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s202(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Accepted
		return this.statusExclusion(202, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s203(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Non-Authoritative Information
		return this.statusExclusion(203, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s204(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//No Content
		return this.statusExclusion(204, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s205(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Reset Content
		return this.statusExclusion(205, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	//300
	...
	public s300(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Multiple Choices
		return this.statusExclusion(300, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s301(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Moved Permanently
		return this.statusExclusion(301, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s303(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Redirect to a GET request
		return this.statusExclusion(303, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	//Error
	//400
	...
	public s400(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Bad Request
		return this.statusExclusion(400, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s401(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Unauthorized
		return this.statusExclusion(401, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s402(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Payment Required
		return this.statusExclusion(402, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s403(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Forbidden
		return this.statusExclusion(403, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s404(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Not Found
		return this.statusExclusion(404, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s409(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Conflict
		return this.statusExclusion(409, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s406(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Not Acceptable
		return this.statusExclusion(406, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s408(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Request Timeout
		return this.statusExclusion(408, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s410(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Gone
		return this.statusExclusion(410, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s413(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Payload Too Large
		return this.statusExclusion(413, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s414(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//URI Too Long
		return this.statusExclusion(414, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s415(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Unsupported Media Type
		return this.statusExclusion(415, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s416(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Range Not Satisfiable
		return this.statusExclusion(416, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s417(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Expectation Failed
		return this.statusExclusion(417, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s418(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//I'm a teapot
		return this.statusExclusion(418, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s421(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Misdirected Request
		return this.statusExclusion(421, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s422(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Unprocessable Content
		return this.statusExclusion(422, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s425(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Too Early
		return this.statusExclusion(425, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s429(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Too Many Request
		return this.statusExclusion(429, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s431(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Request Header Fields Too Large
		return this.statusExclusion(431, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s451(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Unavailable For Legal Reasons
		return this.statusExclusion(451, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	//Server Error
	//500
	...
	public s500(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Internal Server Error
		return this.statusExclusion(500, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s501(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Not Implemented
		return this.statusExclusion(501, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s502(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Bad Gateway
		return this.statusExclusion(502, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s503(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Service Unavailable
		return this.statusExclusion(503, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s504(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Gateway Timeout
		return this.statusExclusion(504, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s505(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//HTTP Version Not Supported
		return this.statusExclusion(505, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s506(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Variant Also Negotiates
		return this.statusExclusion(506, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public s507(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		//Insufficient Storage
		return this.statusExclusion(507, ()=>{ this.parseData(callback as any, responseType as any);});
	}
	...
	public sOthers(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		(async (THIS) => {
	...
	public sAfter(callback: STRING_RESPONSE | JSON_RESPONSE | FILE_RESPONSE | BUFFER_RESPONSE, responseType: RESPONSE_TYPE = "JSON") {
		return this.parseData(callback as any, responseType as any);
	}
	// This
